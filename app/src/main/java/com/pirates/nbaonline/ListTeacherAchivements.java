...
public class ListTeacherAchivements extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_teacher_achivements);
        ...
        databaseReference = firebaseDatabase.getReference("Teacher_Achivements_ImageNames").child(doc);
        list = new ArrayList<>();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(ListTeacherAchivements.this, ""+item , Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(getApplicationContext(),DisplayAchivement.class);
