...
public class TeacherAchivments extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_achivments);
        ...
        storageReference = FirebaseStorage.getInstance().getReference("Teacher_Achivements").child(doc);
        databaseReference = FirebaseDatabase.getInstance().getReference("Teacher_Achivements").child(doc);
        ...
        findViewById(R.id.button6).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(uploadTask != null && uploadTask.isInProgress()) {
                    Toast.makeText(TeacherAchivments.this, "Upload in Progress...", Toast.LENGTH_SHORT).show();
                }
                else{
                    uploadImage();
                }
            ...
            if (!image.equals("")) {
                ...
                uploadTask = storageReference1.putFile(filepath).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(TeacherAchivments.this, "Online Course Image uploaded successfully", Toast.LENGTH_SHORT).show();


                        imageName = uploadImage.getImagename();
                        databaseReference1 = FirebaseDatabase.getInstance().getReference("Teacher_Achivements_ImageNames").child(doc);
