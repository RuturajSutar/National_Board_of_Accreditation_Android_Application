...
public class StudentExtracurricularActivities extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_extracurricular_activities);
        ...
        storageReference = FirebaseStorage.getInstance().getReference("ExtraActivities").child(doc);
        databaseReference = FirebaseDatabase.getInstance().getReference("ExtraActivities").child(doc);
        ...
        findViewById(R.id.button6).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(uploadTask != null && uploadTask.isInProgress()) {
                    Toast.makeText(StudentExtracurricularActivities.this, "Upload in Progress...", Toast.LENGTH_SHORT).show();
                }
                else{
                    uploadImage();
                }
            ...
            if (!image.equals("")) {
                ...
                uploadTask = storageReference1.putFile(filepath).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(StudentExtracurricularActivities.this, "Extra Curricular Image uploaded successfully", Toast.LENGTH_SHORT).show();


                        imageName = uploadImage.getImagename();
                        databaseReference1 = FirebaseDatabase.getInstance().getReference("Extra_Curricular_ImageNames").child(doc);
