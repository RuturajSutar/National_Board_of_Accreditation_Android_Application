...
public class StudentStudentDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_student_details);
        ...
        mRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(StudentStudentDetails.this, "Error Occured", Toast.LENGTH_SHORT).show();
            }
        });
