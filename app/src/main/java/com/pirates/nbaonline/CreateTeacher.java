    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collegeNameSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(CreateTeacher.this, collegeName, Toast.LENGTH_SHORT).show();
            }
        ...
        branchNameSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(CreateTeacher.this, branchName, Toast.LENGTH_SHORT).show();
            }
        ...
        genderSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(CreateTeacher.this, gender, Toast.LENGTH_SHORT).show();
            }
        ...
        create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(aname.isEmpty()){
                    ...
                    Toast.makeText(CreateTeacher.this, "All Fields are Empty", Toast.LENGTH_SHORT).show();
                }
                    ...
                    mFirebaseAuth.createUserWithEmailAndPassword(ausername,apassword).addOnCompleteListener(CreateTeacher.this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                FirebaseUser user = mFirebaseAuth.getCurrentUser();
                                mRef= FirebaseDatabase.getInstance().getReference().child("Teacher");
                                ...
                                mRef1= FirebaseDatabase.getInstance().getReference().child("TeacherDup");
                                mRef1.child(removeAt).setValue(insertValues);
                                Toast.makeText(CreateTeacher.this, "User Created Successfully", Toast.LENGTH_SHORT).show();
                                Intent intent=new Intent(CreateTeacher.this,DeanDashboard.class);
                                startActivity(intent);
                                finish();
                            } else {
                                Toast.makeText(CreateTeacher.this, "Please Enter Valid Username or Password",Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                    ...
                    Toast.makeText(CreateTeacher.this, "Error in creating user", Toast.LENGTH_SHORT).show();
