...
public class StudentEditProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, emaildotat, Toast.LENGTH_SHORT).show();
        ...
        changePassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (myoldpass.isEmpty()){
                    ...
                    Toast.makeText(StudentEditProfile.this, "All Fields are empty", Toast.LENGTH_SHORT).show();
                }
                else if (!(myoldpass.isEmpty() && mynewpass.isEmpty() && myagainnewpass.isEmpty())){
                    ...
                    mRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if (user!=null){
                                                ...
                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            Toast.makeText(StudentEditProfile.this, "password Changed", Toast.LENGTH_SHORT).show();
                                                        }
                                                    }
                                                });
                                    }
                                ...
                                Toast.makeText(StudentEditProfile.this, "Cannot change Password", Toast.LENGTH_SHORT).show();
                            }
...
//
                            if(myoldpass.equals(mypassword) && mynewpass.equals(myagainnewpass)){
                                ...
                                mRef1= FirebaseDatabase.getInstance().getReference().child("Students").child(mycollege).child(mybranch).child(emaildotat);
...
//
                                        if(myoldpass.equals(mypassworda) && mynewpass.equals(myagainnewpass)){
                                            ...
                                            Toast.makeText(StudentEditProfile.this, "Password Changed Successfuly", Toast.LENGTH_SHORT).show();
                                            Intent intent=new Intent(StudentEditProfile.this,StudentDashboard.class);
                                            startActivity(intent);
                                            finish();
                                        }
                                        else {
                                            Toast.makeText(StudentEditProfile.this, "Please Reenter New Password or enter new password having size more than 6", Toast.LENGTH_SHORT).show();
                                        }
                                    ...
                                    public void onCancelled(@NonNull DatabaseError databaseError) {
                                        ...
                                        Toast.makeText(StudentEditProfile.this, "Error Occured", Toast.LENGTH_SHORT).show();
                                    }
                                });
                    ...
                    Toast.makeText(StudentEditProfile.this, "Error in Changing Password", Toast.LENGTH_SHORT).show();
                }
