        ...
        changePassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (myoldpass.isEmpty()){
                    ...
                    Toast.makeText(TeacherEditProfile.this, "All Fields are empty", Toast.LENGTH_SHORT).show();
                }
                else if (!(myoldpass.isEmpty() && mynewpass.isEmpty() && myagainnewpass.isEmpty())){
                    mRef= FirebaseDatabase.getInstance().getReference().child("TeacherDup").child(emaildotat);
                    ...
                    mRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if (user!=null){
                                                ...
                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            Toast.makeText(TeacherEditProfile.this, "password Changed", Toast.LENGTH_SHORT).show();
                                                        }
                                                    }
                                                });
                                    }
                                ...
                                Toast.makeText(TeacherEditProfile.this, "Cannot change Password", Toast.LENGTH_SHORT).show();
                            }
...
//
                            if(myoldpass.equals(mypassword) && mynewpass.equals(myagainnewpass)){
                                ...
                                mRef1= FirebaseDatabase.getInstance().getReference().child("Teacher").child(mycollege).child(mybranch).child(emaildotat);
...
//
                                        if(myoldpass.equals(mypassworda) && mynewpass.equals(myagainnewpass)){
                                            ...
                                            Toast.makeText(TeacherEditProfile.this, "Password Changed Successfuly", Toast.LENGTH_SHORT).show();
                                            Intent intent=new Intent(TeacherEditProfile.this,TeacherDashboard.class);
                                            startActivity(intent);
                                            finish();
                                        }
                                        else {
                                            Toast.makeText(TeacherEditProfile.this, "Please Reenter New Password or enter new password having size more than 6", Toast.LENGTH_SHORT).show();
                                        }
                                    ...
                                    public void onCancelled(@NonNull DatabaseError databaseError) {
                                        ...
                                        Toast.makeText(TeacherEditProfile.this, "Error Occured", Toast.LENGTH_SHORT).show();
                                    }
                                });
                    ...
                    Toast.makeText(TeacherEditProfile.this, "Error in Changing Password", Toast.LENGTH_SHORT).show();
                }
